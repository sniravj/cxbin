...
namespace cxbin
{
	...
	public:
		...
		virtual bool tryLoad(FILE* f, size_t fileSize) override;
		virtual bool load(FILE* f, size_t fileSize, std::vector<trimesh::TriMesh*>& out, ccglobal::Tracer* tracer) override;
